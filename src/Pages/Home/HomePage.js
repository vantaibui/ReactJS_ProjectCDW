                    ...
                    <div className="row">
                        ...
                        <div className="col-3 col-3--modifier">
                            <div className="col-inner col-download-application">
                                ...
                                <p>
                                    Ứng dụng Mona Watch hiện có sẵn trên Google
                                    Play &amp; App Store. Tải nó ngay.
                                </p>
                                <div className="application">
                                    <a href>
                                        <img
                                            src="./images/img-googleplay.jpg"
                                            alt="abc"
                                        />
                                    </a>
                                </div>
